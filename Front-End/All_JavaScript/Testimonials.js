const urlBook = (id) => `http://localhost:42480/api/Books/bynameBooksid/${id}`;
const urlComments =
  "http://localhost:42480/api/commentsreviews/topRatedcommentsreviews";
const urlUser = (id) => `http://localhost:42480/api/User/byIDUserUser/${id}`;
